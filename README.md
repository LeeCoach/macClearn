...
| **Installer (DMG)** | [MacCleaner-1.5.0.dmg](https://github.com/LeeCoach/macClearn/releases/download/v1.5.0/MacCleaner-1.5.0.dmg) (~1.0 MB) |
| **All releases** | https://github.com/LeeCoach/macClearn/releases |

> DMG installers are built automatically by GitHub Actions when a version tag (e.g. `v1.5.0`) is pushed. See [Release workflow](#release-workflow).  
> Each DMG contains **MacCleaner.app** and an **Applications** shortcut for drag-and-drop installation.

### Install

1. Download **MacCleaner-1.5.0.dmg** (~1.0 MB) from [Releases](https://github.com/LeeCoach/macClearn/releases/tag/v1.5.0) (or use **Latest** above).
...
xattr -cr ~/Downloads/MacCleaner-1.5.0.dmg
...
**1.5.0** · Bundle ID: `com.maccleaner.app`
...
| **安装包（DMG）** | [MacCleaner-1.5.0.dmg](https://github.com/LeeCoach/macClearn/releases/download/v1.5.0/MacCleaner-1.5.0.dmg)（约 1.0 MB） |
| **全部版本** | https://github.com/LeeCoach/macClearn/releases |

> 推送版本 tag（如 `v1.5.0`）后，GitHub Actions 会自动构建 DMG 并发布到 Releases。详见 [发布流程](#发布流程)。  
> 安装包内含 **MacCleaner.app** 与 **应用程序（Applications）** 快捷方式，支持拖放安装。

### 安装步骤

1. 从 [Releases](https://github.com/LeeCoach/macClearn/releases/tag/v1.5.0) 下载 **MacCleaner-1.5.0.dmg**（约 1.0 MB，或使用上方的 **Latest**）。
